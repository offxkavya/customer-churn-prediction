...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Assets/SystemArchitecture.png}
...
\midrule
Saksham Miglani & Data Sourcing, Deployment, Streamlit App \\
Kavya Mukhija & Model Training, Evaluation, Feature Engineering, Plotly Visualization \\
Pratyush Parida & Data Sourcing, Deployment, Streamlit App \\
Aditya Samadhiya & Data Preprocessing, EDA, Documentation, Video \\
\bottomrule
\end{tabular}
\end{table}
